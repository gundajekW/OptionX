...
# ==============================================================================
    ...
    # --- 1. მიმდინარე კვირის ავტომატური გამოთვლა ---
    today = datetime.today()
    start_of_week = today - timedelta(days=today.weekday()) # კვირის დასაწყისი (ორშაბათი)
    end_of_week = start_of_week + timedelta(days=6) # კვირის ბოლო (კვირა)
    ...
    # --- 2. მაკროების სექცია (მხოლოდ NY დროით) ---
    ...
    # --- 3. მიმდინარე კვირის გეგმა ---
    st.markdown("---")
    st.subheader("📰 კვირის მაკრო კალენდარი (ForexFactory)")
